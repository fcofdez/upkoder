...
case class UpcloseBroadcast(id: Int, account_id: Int, cumulative_participant_count: Int, created_at: DateTime) extends Ordered[UpcloseBroadcast] {
...
trait Protocols extends DefaultJsonProtocol {
  ...
  implicit val BroadcastFormat = jsonFormat4(UpcloseBroadcast.apply)
